...
Item {
    ...
    IconItem {
        ...
        anchors.margins: LongUI.Units.largeSpacing * 2
    ...
    MouseArea {
        ...
        onClicked: {
            if (mouse.button == Qt.LeftButton)
                ...
                uninstallItem.visible = appManager.isLongOS()
    ...
    Label {
        ...
        anchors {
            ...
            margins: LongUI.Units.smallSpacing
        }
        ...
        width: parent.width - 2 * LongUI.Units.smallSpacing
