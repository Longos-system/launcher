...
Item {
    ...
    Dialog {
        ...
        width: _uninstallDialogLayout.implicitWidth + LongUI.Units.largeSpacing * 2
        height: _uninstallDialogLayout.implicitHeight + LongUI.Units.largeSpacing * 2
        ...
        ColumnLayout {
            ...
            spacing: LongUI.Units.largeSpacing * 1.5
...
//    }
    ...
    ColumnLayout {
        ...
        Item {
            id: searchItem
            Layout.fillWidth: true
            height: fontMetrics.height + LongUI.Units.largeSpacing
            ...
            TextField {
                ...
                leftPadding: textField.activeFocus ? _placeImage.width + LongUI.Units.largeSpacing : LongUI.Units.largeSpacing
                ...
                Item {
                    ...
                    opacity: 0.6
                    x: textField.activeFocus ? LongUI.Units.smallSpacing : (textField.width - placeHolderItem.width) / 2
                    y: 0
                    ...
                    RowLayout {
                        ...
                        Image {
                            id: _placeImage
                            height: placeHolderItem.height - LongUI.Units.largeSpacing
                            width: height
